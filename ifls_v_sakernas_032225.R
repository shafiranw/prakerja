...
# Load Dataset ----------------------------------------------------------------#
ifls <- read.csv("~/Documents/PhD/Dissertation/code_data/data/IFLS/ifls_032225.csv")
...
# Save Dataset ----------------------------------------------------------------#
write.csv(ifls,"ifls_match_032325.csv", row.names=FALSE)
write.csv(sakernas,"sakernas_match_032325.csv", row.names=FALSE)
